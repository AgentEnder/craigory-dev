import { j as jsxRuntimeExports, r as reactExports, i as import5, o as onRenderClient } from '../chunks/chunk-Byhje8yp.js';
import { F as FaGithub, a as FaGlobe, b as FaBook, c as FaStar, d as FaCalendar, u as useData } from '../chunks/chunk-CyaQRYUg.js';
import { I as IoClose, G as GenIcon, i as import3$1 } from '../chunks/chunk-oebehwVc.js';
import { t as toDate, d as differenceInCalendarDays, f as format } from '../chunks/chunk-DI4sGg5h.js';
import { C as ContentMarker } from '../chunks/chunk-CY1IrHah.js';
...
/*! pages/projects/components/sort-functions.ts [vike:pluginModuleBanner] */
...
const sortByRelevance = (projects) => {
...
const sortByDownloads = () => (a, b) => totalDownloads(b) - totalDownloads(a);
const sortByLastCommit = () => (a, b) => lastCommitTime(b) - lastCommitTime(a);
const SORT_OPTIONS = [
...
function FilterBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("table", { ...tableProps, className: styles$1["filter-table"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "sort-by", children: "Sort by" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          id: "sort-by",
...
function ProjectCard({ project }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: styles.projectCard, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles.projectInfo, children: [
      ...
      p.documentationUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.infoRow, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles.infoLabel, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaBook, {}),
          "Documentation"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.infoValue, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DeploymentLink, { deployment: p.documentationUrl }) })
      ] }),
...
function Page() {
  ...
  const [sortFn, setSortFn] = reactExports.useState(() => sortByRelevance);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    sortedProjects.map((p, idx) => {
      ...
      const anchor = isContributor ? p.data.full_name.replace("/", "-") : p.repo;
      const title = isContributor ? p.data.full_name : p.repo;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-wrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${anchor}`, className: "content-marker-link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContentMarker, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: anchor, children: title }),
          isContributor && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {

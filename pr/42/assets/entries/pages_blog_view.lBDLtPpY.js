import { r as reactExports, j as jsxRuntimeExports, u as usePageContext, i as import5, o as onRenderClient } from '../chunks/chunk-DqTgHvO9.js';
import { P as PostContext, g as getBlogUrl, s as slugMap } from '../chunks/chunk-CFUo_itN.js';
import { C as ContentMarker } from '../chunks/chunk-CiO_TN-f.js';
import { L as Link, i as import3 } from '../chunks/chunk-B9Drug8a.js';
import { f as format } from '../chunks/chunk-DI4sGg5h.js';
import '../chunks/chunk-BhW2AVEc.js';
/* empty css                       */
/* empty css                       */

/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/components/cite.module.scss [vike:pluginModuleBanner] */
const citation = "_citation_5mrsj_1";
const marker = "_marker_5mrsj_7";
const anchor = "_anchor_5mrsj_13";
const popover = "_popover_5mrsj_31";
const popoverBody = "_popoverBody_5mrsj_81";
const classes$2 = {
	citation: citation,
	marker: marker,
	anchor: anchor,
...
/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/components/cite.tsx [vike:pluginModuleBanner] */
function Cite({ n, href, children }) {
  const cleanId = reactExports.useId().replace(/[^a-zA-Z0-9]/g, "");
  const anchorVariables = {
    "--cite-anchor": `--cite-${cleanId}`
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: classes$2["citation"], style: anchorVariables, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("sup", { className: classes$2["marker"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href,
        target: "_blank",
        rel: "noopener noreferrer",
        className: classes$2["anchor"],
        children: [
          "[",
          n,
          "]"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("cite", { className: classes$2["popover"], role: "tooltip", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes$2["popoverBody"], children }) })
  ] });
}
...
const filename = "_filename_1f9vu_49";
const copied = "_copied_1f9vu_88";
const styles = {
...
const NON_COPYABLE_LANGUAGES = /* @__PURE__ */ new Set([
  "text",
  "plaintext",
  "plain",
  "output",
...
function getCodeLanguage(node) {
  if (!reactExports.isValidElement(node)) return void 0;
...
function CodeWrapper({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        renderHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles["code-header"], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles["code-header-left"], children: [
            showLanguage && language && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles["language-pill"], children: LANGUAGE_LABELS[language] ?? language }),
            filename && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles["filename"], children: filename })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { ref: preRef, className: styles["code-wrapper"], children })
      ]
    }
  );
}
function CopyIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "5", y: "5", width: "9", height: "9", rx: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M11 5V3.5A1.5 1.5 0 0 0 9.5 2h-6A1.5 1.5 0 0 0 2 3.5v6A1.5 1.5 0 0 0 3.5 11H5" })
      ]
    }
  );
}
function CheckIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      "aria-hidden": "true",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 8.5l3.5 3.5L13 5" })
    }
  );
}
...
/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/components/tabs.module.scss [vike:pluginModuleBanner] */
const tabs = "_tabs_1e66j_1";
const tabList = "_tabList_1e66j_9";
const tabButton = "_tabButton_1e66j_17";
const tabButtonActive = "_tabButtonActive_1e66j_42";
const tabPanel = "_tabPanel_1e66j_53";
const classes$1 = {
	tabs: tabs,
	tabList: tabList,
	tabButton: tabButton,
...
/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/components/tabs.tsx [vike:pluginModuleBanner] */
...
function useSyncedLabel(groupId, availableLabels, fallback) {
  const [label, setLabel] = reactExports.useState(fallback);
...
function Tabs({ groupId, children }) {
  ...
  const panels = reactExports.Children.toArray(children).filter(
    (child) => reactExports.isValidElement(child) && child.type === Tab
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes$1["tabs"], children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes$1["tabList"], role: "tablist", children: labels.map((label) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `${classes$1["tabButton"]} ${isActive ? classes$1["tabButtonActive"] : ""}`,

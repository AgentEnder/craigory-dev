...
function _createMdxContent$a(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: ["A minimum release age — or “cooldown” — tells your package manager to ignore any version of a dependency that was published less than ", jsxRuntimeExports.jsx(_components.em, {
        children: "N"
      }), " time ago. It is a one-line config change that buys you most of the protection you would get from a sophisticated supply-chain monitoring setup: the typical malicious release is caught and pulled from the registry within a few hours, so even a one-day delay routes around the worst of them.", jsxRuntimeExports.jsx("sup", {
      ...
      children: ["Every major Node.js package manager now supports this, but each picked its own name for the setting and its own unit of time. The notes below are mostly a cross-reference of what to write, where to write it, and the parts that bit me (or are about to). The technical bones come from Matteo Collina’s original gist on the npm / pnpm / Yarn setup,", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
      }), " Tom Ricci’s expansion that added Bun,", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-2",
          children: "[2]"
        })
      }), " and each tool’s own documentation.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-3",
          children: "[3]"
        })
      ...
      children: ["\n", jsxRuntimeExports.jsx(_components.li, {
        ...
        children: [jsxRuntimeExports.jsx(_components.a, {
          href: "#things-to-know-before-you-turn-it-on",
          children: "Things to know before you turn it on"
        }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
          children: ["\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#the-gate-runs-at-install-not-when-a-bot-opens-a-pr",
              children: "The gate runs at install, not when a bot opens a PR"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#a-repo-that-pins-an-older-package-manager-wins-every-time",
              children: "A repo that pins an older package manager wins, every time"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#a-lax-repo-config-beats-a-stricter-user-config",
              children: "A lax repo config beats a stricter user config"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
            ...
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#defaults-are-about-to-move",
              children: "Defaults are about to move"
            })
          }), "\n"]
        }), "\n"]
      }), "\n", jsxRuntimeExports.jsxs(_components.li, {
      ...
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        ...
        }), ", measured in ", jsxRuntimeExports.jsx(_components.strong, {
          children: "days"
        }), ", available from npm CLI ", jsxRuntimeExports.jsx(_components.strong, {
          children: "11.10.0"
        }), " (Feb 2026).", jsxRuntimeExports.jsx("sup", {
          children: jsxRuntimeExports.jsx("a", {
            href: "#ref-3",
            children: "[3]"
          })
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ", available from pnpm ", jsxRuntimeExports.jsx(_components.strong, {
          children: "10.16"
        }), " (Sep 2025); the default became ", jsxRuntimeExports.jsx(_components.code, {
          children: "1440"
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ", available from Yarn Berry ", jsxRuntimeExports.jsx(_components.strong, {
          children: "4.10.0"
        }), ".", jsxRuntimeExports.jsx("sup", {
          children: jsxRuntimeExports.jsx("a", {
            href: "#ref-5",
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "seconds"
        }), ", available from Bun ", jsxRuntimeExports.jsx(_components.strong, {
          children: "1.3.0"
        }), ".", jsxRuntimeExports.jsx("sup", {
          children: jsxRuntimeExports.jsx("a", {
            href: "#ref-6",
      ...
      id: "things-to-know-before-you-turn-it-on",
      children: ["Things to know before you turn it on", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#things-to-know-before-you-turn-it-on",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["I have these up front because three of them are how you ", jsxRuntimeExports.jsx(_components.em, {
        children: "think"
      }), " the cooldown is protecting you when it actually isn’t."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "the-gate-runs-at-install-not-when-a-bot-opens-a-pr",
      children: ["The gate runs at install, not when a bot opens a PR", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#the-gate-runs-at-install-not-when-a-bot-opens-a-pr",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["The check happens when the package manager resolves and installs a version. A bot that proposes an update is doing neither — so Renovate and Dependabot will happily file PRs against versions your install command will refuse. Configure their cooldown options too: Renovate 42’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "config:best-practices"
      }), " preset already enables a three-day cooldown for npm,", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
      }), " and Dependabot’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "cooldown.default-days"
      }), " is the corresponding knob."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "a-repo-that-pins-an-older-package-manager-wins-every-time",
      children: ["A repo that pins an older package manager wins, every time", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-repo-that-pins-an-older-package-manager-wins-every-time",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["If a project pins its package manager — via the ", jsxRuntimeExports.jsx(_components.code, {
        ...
        children: "package.json"
      }), ", Corepack, Volta, a Docker base image, the ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " action’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "version-file"
      }), " input, anything — the version the project pins is the version that actually runs your install. If that pinned version predates cooldown support, the gate does not exist for that repo, no matter what your globally installed package manager is or what your user-level config says. An older binary has no concept of the setting and silently ignores it."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["This is the failure mode I see most often. The fix is to confirm the version that actually runs (", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm --version"
      }), " from inside the repo, ", jsxRuntimeExports.jsx(_components.code, {
        children: "corepack pnpm --version"
      }), ", the ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " log line in CI) is new enough to honor the setting."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "a-lax-repo-config-beats-a-stricter-user-config",
      children: ["A lax repo config beats a stricter user config", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-lax-repo-config-beats-a-stricter-user-config",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Per-project settings take precedence over per-user settings in all four tools. If your ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.npmrc"
      }), " / ", jsxRuntimeExports.jsx(_components.code, {
      ...
      }), " sets a one-day cooldown but the project sets zero — or sets nothing on an older tool version where the default is zero — the project value wins. The setting behaves like a project policy, not a personal safety preference."]
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      children: "Practically, this means setting cooldown globally on your laptop is not a substitute for setting it in each repo. A repo that has not opted in is a repo without a cooldown, for you."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      ...
      children: ["None of the four tools let you apply the gate to one registry but not another. Internal packages from a private registry get delayed alongside everything else unless you list them in the per-tool exclude option. npm does not have an exclude option yet — there is an open issue tracking it.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-7",
          children: "[7]"
        })
      ...
      id: "defaults-are-about-to-move",
      children: ["Defaults are about to move", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#defaults-are-about-to-move",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["pnpm 11 already enables the gate at 1440 minutes by default; npm CLI v12 is expected to follow.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
      }), " If you set a value explicitly today, you keep the behavior you wrote down when the defaults shift under you."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "npm",
      children: ["npm", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#npm",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Put the setting in the project’s ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), ":"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: ".npmrc",
      ...
      children: ["The value is in days. You cannot combine it with ", jsxRuntimeExports.jsx(_components.code, {
        children: "--before"
      }), " in the same invocation; npm errors out if both are present. Older npm CLI versions that don’t recognize the key will print:"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      children: jsxRuntimeExports.jsx(_components.code, {
      ...
      children: "The warning is cosmetic — the setting still applies on a CLI that supports it, and is harmlessly ignored on one that doesn’t."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "user-wide",
      ...
      children: ["That writes to ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.npmrc"
      }), ". Swap ", jsxRuntimeExports.jsx(_components.code, {
        children: "user"
      }), " for ", jsxRuntimeExports.jsx(_components.code, {
        children: "global"
      }), " if you want it in the global npm config instead."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "pnpm",
      children: ["pnpm", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#pnpm",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Since pnpm 11, the canonical home is ", jsxRuntimeExports.jsx(_components.code, {
      ...
      children: "If you publish internal packages and want them to bypass the gate:"
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: "pnpm-workspace.yaml",
      children: jsxRuntimeExports.jsxs(_components.code, {
        className: "hljs language-yaml",
      ...
      children: ["On pnpm 10.x you write the same idea in ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      ...
      children: ["Worth knowing on 10.x: there is an open bug where ", jsxRuntimeExports.jsx(_components.code, {
        children: "minimumReleaseAge"
      }), " is silently ignored if any package in the workspace has ", jsxRuntimeExports.jsx(_components.code, {
        children: "shared-workspace-lockfile=false"
      }), " set in its ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), ".", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-8",
      ...
      }), " If you’ve configured the gate but it doesn’t seem to be doing anything, that’s the first thing I’d check."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "user-wide-1",
      children: ["User-wide", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
      ...
      children: ["On pnpm 11+, non-auth settings written this way land in ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.config/pnpm/config.yaml"
      ...
      id: "yarn-berry-410",
      children: ["Yarn (Berry 4.10+)", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#yarn-berry-410",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "If some packages need to skip the gate:"
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: ".yarnrc.yml",
      children: jsxRuntimeExports.jsxs(_components.code, {
        className: "hljs language-yaml",
      ...
      children: [jsxRuntimeExports.jsx(_components.code, {
        children: "npmPreapprovedPackages"
      }), " accepts both glob patterns and exact locators (e.g. ", jsxRuntimeExports.jsx(_components.code, {
        children: "@aws-sdk/types@3.877.0"
      }), "), which is a notch more flexible than pnpm’s package-name-only exclude list."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["The docs suggest you can pass a duration string like ", jsxRuntimeExports.jsx(_components.code, {
        children: "\"7d\""
      }), " instead of a number, but there’s an outstanding bug where the suffix is silently dropped.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-9",
          children: "[9]"
        })
      }), " Until that’s resolved everywhere, stick to a plain minute count: one day is ", jsxRuntimeExports.jsx(_components.code, {
      ...
      id: "bun",
      children: ["Bun", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#bun",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Bun puts it under ", jsxRuntimeExports.jsx(_components.code, {
        children: "[install]"
      }), " in ", jsxRuntimeExports.jsx(_components.code, {
        children: "bunfig.toml"
      }), ":"]
      ...
      children: ["To skip the gate for a few packages, use ", jsxRuntimeExports.jsx(_components.code, {
      ...
      children: ["There is no user-wide config story yet — Bun reads project-level ", jsxRuntimeExports.jsx(_components.code, {
        children: "bunfig.toml"
      }), " only. An open PR is wiring up support;", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-10",
          children: "[10]"
        })
      }), " when it merges, the same key in a user-wide ", jsxRuntimeExports.jsx(_components.code, {
        children: "bunfig.toml"
      }), " will work the way it does for the other tools."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "references",
      children: ["References", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
      ...
      children: [jsxRuntimeExports.jsxs("li", {
        ...
        }), " (gist, April 2026). Original write-up; covered npm, pnpm, and Yarn, and the install-time vs. PR-time distinction."]
        ...
        children: ["Tom Ricci, ", jsxRuntimeExports.jsx("a", {
          ...
          children: "“Configuring minimum release age across npm, pnpm, yarn, and bun”"
        }), " (gist). Extends Collina’s notes with Bun coverage, version metadata, and the exclusion-list options per tool."]
      }), jsxRuntimeExports.jsxs("li", {
        id: "ref-3",
        children: ["npm CLI docs, ", jsxRuntimeExports.jsx("a", {
        ...
        id: "ref-4",
        children: ["pnpm docs, ", jsxRuntimeExports.jsx("a", {
        ...
        id: "ref-5",
        children: ["Yarn docs, ", jsxRuntimeExports.jsx("a", {
        ...
        id: "ref-6",
        children: ["Bun docs, ", jsxRuntimeExports.jsx("a", {
        ...
        children: ["npm CLI issue ", jsxRuntimeExports.jsx("a", {
          ...
          children: "#8994"
        }), " — tracking an exclusion list for ", jsxRuntimeExports.jsx("code", {
          children: "min-release-age"
        }), "."]
      }), jsxRuntimeExports.jsxs("li", {
        id: "ref-8",
        ...
        id: "ref-10",
        children: ["Bun PR ", jsxRuntimeExports.jsx("a", {
          href: "https://github.com/oven-sh/bun/pull/28727",
          children: "#28727"
        }), " — user-wide ", jsxRuntimeExports.jsx("code", {
          children: "bunfig.toml"
        }), " support."]
      })]
    })]

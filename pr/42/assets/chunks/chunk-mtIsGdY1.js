import { j as jsxRuntimeExports, r as reactExports } from './chunk-DqTgHvO9.js';
...
function _createMdxContent$e(props) {
  ...
  if (!Anchor) _missingMdxReference$e("Anchor");
...
function _missingMdxReference$e(id, component) {
...
function _createMdxContent$d(props) {
  ...
  if (!LinkToPost) _missingMdxReference$d("LinkToPost");
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
...
/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/posts/package-manager-release-cooldown/contents.mdx [vike:pluginModuleBanner] */
const collinaGist = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Matteo Collina,", ' ', jsxRuntimeExports.jsx("a", {
...
const ricciGist = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Tom Ricci,", ' ', jsxRuntimeExports.jsx("a", {
  ...
  }), ' ', "(gist). Extends Collina's notes with Bun coverage and per-tool exclusion options."]
});
const npmDocs = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["npm CLI documentation,", ' ', jsxRuntimeExports.jsx("a", {
...
const pnpmDocs = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["pnpm documentation,", ' ', jsxRuntimeExports.jsx("a", {
...
const yarnDocs = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Yarn documentation,", ' ', jsxRuntimeExports.jsx("a", {
...
const bunDocs = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Bun documentation,", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://bun.sh/docs/runtime/bunfig#install-minimumreleaseage",
    children: jsxRuntimeExports.jsx("code", {
      children: "install.minimumReleaseAge"
    })
  }), "."]
});
const npmExcludeIssue = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["npm CLI issue", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://github.com/npm/cli/issues/8994",
    children: "#8994"
  }), ". Tracks an exclusion list for ", jsxRuntimeExports.jsx("code", {
    children: "min-release-age"
  }), "."]
});
const pnpmLockfileBug = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["pnpm issue", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://github.com/pnpm/pnpm/issues/10008",
    children: "#10008"
  }), ".", ' ', jsxRuntimeExports.jsx("code", {
    children: "minimumReleaseAge"
  }), " silently ignored on pnpm 10.x when any workspace package sets ", jsxRuntimeExports.jsx("code", {
    children: "shared-workspace-lockfile=false"
  }), "."]
});
const yarnSuffixBug = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Yarn issue", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://github.com/yarnpkg/berry/issues/6991",
    children: "#6991"
  }), ". Duration suffixes silently dropped when parsing ", jsxRuntimeExports.jsx("code", {
    children: "npmMinimalAgeGate"
  }), "."]
});
const bunUserWidePr = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Bun pull request", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://github.com/oven-sh/bun/pull/28727",
    children: "#28727"
  }), ". Adds user-wide ", jsxRuntimeExports.jsx("code", {
...
function _createMdxContent$a(props) {
  ...
  if (!Cite) _missingMdxReference$a("Cite");
  if (!Tab) _missingMdxReference$a("Tab");
  if (!Tabs) _missingMdxReference$a("Tabs");
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      id: "configuring-minimum-release-age-across-npm-pnpm-yarn-and-bun",
      children: "Configuring minimum release age across npm, pnpm, yarn, and bun"
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["A minimum release age (or “cooldown”) instructs a package manager to ignore any dependency version published less than a configured amount of time ago. The reference below was assembled from Matteo Collina’s original gist covering npm, pnpm, and Yarn,", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      }), " Tom Ricci’s expansion adding Bun,", jsxRuntimeExports.jsx(Cite, {
        n: 2,
        href: "https://gist.github.com/tom-ricci/bade55606ebb7a550598f11e29f1d6b0",
        children: ricciGist
      }), " and the official documentation for each tool.", jsxRuntimeExports.jsx(Cite, {
        n: 3,
        href: "https://docs.npmjs.com/cli/v11/using-npm/config#min-release-age",
        children: npmDocs
      }), jsxRuntimeExports.jsx(Cite, {
        n: 4,
        href: "https://pnpm.io/settings#minimumreleaseage",
        children: pnpmDocs
      }), jsxRuntimeExports.jsx(Cite, {
      ...
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.a, {
          ...
          children: ["\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#what-the-setting-does",
              children: "What the setting does"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#when-each-tool-added-support",
              children: "When each tool added support"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#why-configure-both-scopes",
              children: "Why configure both scopes"
            })
          }), "\n"]
        }), "\n"]
      }), "\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.a, {
          ...
          children: ["\n", jsxRuntimeExports.jsx(_components.li, {
            ...
            children: [jsxRuntimeExports.jsx(_components.a, {
              ...
              children: ["\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
                  href: "#the-check-runs-at-install-time",
                  children: "The check runs at install time"
                })
              }), "\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
                  href: "#no-per-registry-scope",
                  children: "No per-registry scope"
                })
              }), "\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
                  href: "#defaults-are-likely-to-shift",
                  children: "Defaults are likely to shift"
                })
              }), "\n"]
            }), "\n"]
          }), "\n"]
        ...
        children: [jsxRuntimeExports.jsx(_components.a, {
          ...
          children: ["\n", jsxRuntimeExports.jsx(_components.li, {
            ...
            children: [jsxRuntimeExports.jsx(_components.a, {
              ...
              children: ["\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
                  href: "#a-repository-pinning-an-older-package-manager-disables-the-gate",
                  children: "A repository pinning an older package manager disables the gate"
                })
              }), "\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
                  href: "#a-repositorys-looser-configuration-overrides-a-stricter-user-configuration",
                  children: "A repository’s looser configuration overrides a stricter user configuration"
                })
              }), "\n"]
            }), "\n"]
          }), "\n"]
      ...
      id: "overview",
      children: ["Overview", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#overview",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "what-the-setting-does",
      children: ["What the setting does", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#what-the-setting-does",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "A cooldown delays the moment at which a freshly published version becomes installable. With a one-day cooldown, a version published less than 24 hours ago is invisible to the resolver: installs proceed as if it did not exist yet."
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["The value of this gate comes from the typical lifecycle of a malicious release. Compromised versions are usually flagged and removed from the registry within a few hours of publication, often before most teams have seen them.", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      }), " A 24-hour delay is enough to filter the majority of those incidents at the install layer without requiring any monitoring, scanning, or human review."]
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      children: "The gate does not detect malicious code, audit dependencies, or block known-bad versions. It is a single, blunt rule applied to every package version in the resolution: too new, ignored. That bluntness is the source of its leverage; it costs effectively nothing to turn on and runs on every install without configuration drift."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "when-each-tool-added-support",
      children: ["When each tool added support", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#when-each-tool-added-support",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "Each tool picked its own setting name and its own unit of time:"
    }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "min-release-age"
        }), ", in ", jsxRuntimeExports.jsx(_components.strong, {
          children: "days"
        }), ". npm CLI ", jsxRuntimeExports.jsx(_components.strong, {
          children: "11.10.0"
        }), ", released February 2026.", jsxRuntimeExports.jsx(Cite, {
          n: 3,
          href: "https://docs.npmjs.com/cli/v11/using-npm/config#min-release-age",
          children: npmDocs
        })]
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ". pnpm ", jsxRuntimeExports.jsx(_components.strong, {
          children: "10.16"
        }), ", released September 2025; the default became ", jsxRuntimeExports.jsx(_components.code, {
          children: "1440"
        }), " in pnpm ", jsxRuntimeExports.jsx(_components.strong, {
          children: "11.0"
        }), ".", jsxRuntimeExports.jsx(Cite, {
          n: 4,
          href: "https://pnpm.io/settings#minimumreleaseage",
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ". Yarn Berry ", jsxRuntimeExports.jsx(_components.strong, {
          children: "4.10.0"
        }), ".", jsxRuntimeExports.jsx(Cite, {
          n: 5,
          href: "https://yarnpkg.com/configuration/yarnrc#npmMinimalAgeGate",
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "seconds"
        }), ". Bun ", jsxRuntimeExports.jsx(_components.strong, {
          children: "1.3.0"
        }), ".", jsxRuntimeExports.jsx(Cite, {
          n: 6,
          href: "https://bun.sh/docs/runtime/bunfig#install-minimumreleaseage",
      ...
      id: "why-configure-both-scopes",
      children: ["Why configure both scopes", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#why-configure-both-scopes",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "The setting can be written into a repository’s package-manager config or into the user-level config on a machine. The two scopes answer different questions, and neither replaces the other."
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["A ", jsxRuntimeExports.jsx(_components.strong, {
        children: "per-project"
      }), " value is committed to the repository. It applies to every developer and every CI run that uses a supported package manager version. It is the canonical place to declare policy for a codebase, and the only way to ensure all contributors observe the same cooldown without coordinating their dotfiles. It does nothing in repositories that have not been configured."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["A ", jsxRuntimeExports.jsx(_components.strong, {
        children: "user-wide"
      }), " value applies on a single machine, across every repository whose project-level config does not override it. It is the only way to extend the cooldown to repositories that have not opted in, including dependencies cloned for inspection, scratch projects, and other people’s repos opened from a clone. It is silently bypassed inside repositories that pin an older package manager, and inside repositories that declare a looser value at the project level (see the caveats under each section)."]
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      children: "The two scopes compose. A per-project value protects the codebase against published policy violations; a user-wide value protects the machine against repositories that have not yet taken responsibility for their own cooldown. Setting both is the only configuration that gives a known floor everywhere the machine touches."
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "per-project",
      children: ["Per-project", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#per-project",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "setup",
      children: ["Setup", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#setup",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "Per-project configuration lives in the package manager’s project-local config file and is committed to the repository. The selected tab is remembered across the rest of the post."
    }), "\n", jsxRuntimeExports.jsxs(Tabs, {
      groupId: "package-manager",
      children: [jsxRuntimeExports.jsxs(Tab, {
        label: "npm",
        children: [jsxRuntimeExports.jsxs(_components.p, {
          children: ["The setting belongs in the project’s ", jsxRuntimeExports.jsx(_components.code, {
            children: ".npmrc"
          }), ":"]
        }), jsxRuntimeExports.jsx(_components.pre, {
          filename: ".npmrc",
          ...
          children: ["The value is in days. The setting cannot be combined with ", jsxRuntimeExports.jsx(_components.code, {
            children: "--before"
      ...
      }), jsxRuntimeExports.jsxs(Tab, {
        label: "pnpm",
        children: [jsxRuntimeExports.jsxs(_components.p, {
          children: ["Since pnpm 11, the canonical location is ", jsxRuntimeExports.jsx(_components.code, {
          ...
          children: ["Internal packages that should bypass the gate can be listed under ", jsxRuntimeExports.jsx(_components.code, {
          ...
          children: ["On pnpm 10.x, the same setting is written in ", jsxRuntimeExports.jsx(_components.code, {
            children: ".npmrc"
          ...
          children: ["A known bug on pnpm 10.x causes ", jsxRuntimeExports.jsx(_components.code, {
            children: "minimumReleaseAge"
          }), " to be silently ignored when any package in the workspace sets ", jsxRuntimeExports.jsx(_components.code, {
            children: "shared-workspace-lockfile=false"
          }), " in its ", jsxRuntimeExports.jsx(_components.code, {
            children: ".npmrc"
          }), ".", jsxRuntimeExports.jsx(Cite, {
            n: 8,
            href: "https://github.com/pnpm/pnpm/issues/10008",
        ...
        label: "Yarn",
        children: [jsxRuntimeExports.jsxs(_components.p, {
          children: ["The setting belongs in ", jsxRuntimeExports.jsx(_components.code, {
            children: ".yarnrc.yml"
          ...
          children: ["Packages that should bypass the gate can be listed under ", jsxRuntimeExports.jsx(_components.code, {
          ...
          children: [jsxRuntimeExports.jsx(_components.code, {
            children: "npmPreapprovedPackages"
          }), " accepts both glob patterns and exact locators (for example, ", jsxRuntimeExports.jsx(_components.code, {
            children: "@aws-sdk/types@3.877.0"
          }), "), giving it more granularity than pnpm’s package-name-only exclude list."]
        }), jsxRuntimeExports.jsxs(_components.p, {
          children: ["The documentation states that a duration suffix such as ", jsxRuntimeExports.jsx(_components.code, {
            children: "\"7d\""
          }), " is accepted, but a known parsing bug causes the suffix to be dropped.", jsxRuntimeExports.jsx(Cite, {
            n: 9,
            href: "https://github.com/yarnpkg/berry/issues/6991",
            children: yarnSuffixBug
          }), " Until that is resolved, a plain minute count is the reliable form: one day is ", jsxRuntimeExports.jsx(_components.code, {
            children: "npmMinimalAgeGate: 1440"
          }), "."]
        })]
      }), jsxRuntimeExports.jsxs(Tab, {
        label: "Bun",
        children: [jsxRuntimeExports.jsxs(_components.p, {
          children: ["The setting belongs under ", jsxRuntimeExports.jsx(_components.code, {
            children: "[install]"
          }), " in ", jsxRuntimeExports.jsx(_components.code, {
            children: "bunfig.toml"
          }), ":"]
          ...
          children: ["The value is in seconds. One day is ", jsxRuntimeExports.jsx(_components.code, {
            children: "86400"
          }), "."]
        }), jsxRuntimeExports.jsxs(_components.p, {
          children: ["Packages that should bypass the gate can be listed under ", jsxRuntimeExports.jsx(_components.code, {
      ...
      id: "caveats",
      children: ["Caveats", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#caveats",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "the-check-runs-at-install-time",
      children: ["The check runs at install time", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#the-check-runs-at-install-time",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["The cooldown is enforced when the package manager resolves and installs a version, not when an automation suggests one. Renovate and Dependabot will open update PRs regardless of any cooldown configured in the package manager itself, so their own cooldown options must be set independently. Renovate 42’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "config:best-practices"
      }), " preset enables a three-day cooldown for npm by default.", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      }), " Dependabot exposes the equivalent control as ", jsxRuntimeExports.jsx(_components.code, {
        children: "cooldown.default-days"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h4, {
      id: "no-per-registry-scope",
      children: ["No per-registry scope", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#no-per-registry-scope",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["None of the four tools support applying the gate to one registry but not another. Internal packages from a private registry are subject to the cooldown unless explicitly listed in the per-tool exclusion option. npm does not yet expose an exclusion option; an issue is open against the CLI tracking it.", jsxRuntimeExports.jsx(Cite, {
        n: 7,
        href: "https://github.com/npm/cli/issues/8994",
        children: npmExcludeIssue
      })]
    }), "\n", jsxRuntimeExports.jsxs(_components.h4, {
      id: "defaults-are-likely-to-shift",
      children: ["Defaults are likely to shift", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#defaults-are-likely-to-shift",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["pnpm 11 enables the gate by default at 1440 minutes, and npm CLI v12 is expected to do the same.", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      }), " Setting the value explicitly today preserves the current configured behavior when the upstream defaults change."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "user-wide",
      children: ["User-wide", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#user-wide",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "User-wide configuration applies on a single machine, across every repository that does not override it. As noted in the caveats below, project-level configuration takes precedence over the values shown here."
    }), "\n", jsxRuntimeExports.jsxs(Tabs, {
      groupId: "package-manager",
      children: [jsxRuntimeExports.jsxs(Tab, {
        label: "npm",
        children: [jsxRuntimeExports.jsx(_components.pre, {
          children: jsxRuntimeExports.jsxs(_components.code, {
            className: "hljs language-bash",
            children: ["npm config ", jsxRuntimeExports.jsx(_components.span, {
              className: "hljs-built_in",
              children: "set"
            }), " min-release-age 1 --location=user\n"]
          })
        }), jsxRuntimeExports.jsxs(_components.p, {
          children: ["This writes to ", jsxRuntimeExports.jsx(_components.code, {
            children: "~/.npmrc"
          }), ". Substituting ", jsxRuntimeExports.jsx(_components.code, {
            children: "global"
        ...
        children: [jsxRuntimeExports.jsx(_components.pre, {
          children: jsxRuntimeExports.jsxs(_components.code, {
            className: "hljs language-bash",
            children: ["pnpm config ", jsxRuntimeExports.jsx(_components.span, {
              className: "hljs-built_in",
              children: "set"
            }), " minimumReleaseAge 1440 --location=user\n"]
          })
        }), jsxRuntimeExports.jsxs(_components.p, {
          children: ["On pnpm 11 and later, non-auth settings written this way are stored in ", jsxRuntimeExports.jsx(_components.code, {
            children: "~/.config/pnpm/config.yaml"
          }), " rather than ", jsxRuntimeExports.jsx(_components.code, {
            children: "~/.npmrc"
          }), "."]
        })]
      }), jsxRuntimeExports.jsxs(Tab, {
        ...
        children: [jsxRuntimeExports.jsx(_components.pre, {
          children: jsxRuntimeExports.jsxs(_components.code, {
            className: "hljs language-bash",
            children: ["yarn config ", jsxRuntimeExports.jsx(_components.span, {
              className: "hljs-built_in",
              children: "set"
          ...
          children: [jsxRuntimeExports.jsx(_components.code, {
            children: "--home"
          }), " writes to ", jsxRuntimeExports.jsx(_components.code, {
            children: "~/.yarnrc.yml"
        ...
        label: "Bun",
        children: jsxRuntimeExports.jsxs(_components.p, {
          children: ["Bun reads project-level ", jsxRuntimeExports.jsx(_components.code, {
            children: "bunfig.toml"
          }), " only; user-wide configuration is not yet supported. An open pull request adds the corresponding behavior.", jsxRuntimeExports.jsx(Cite, {
            n: 10,
            href: "https://github.com/oven-sh/bun/pull/28727",
            children: bunUserWidePr
          }), " Once merged, the same key written in a user-wide ", jsxRuntimeExports.jsx(_components.code, {
            children: "bunfig.toml"
          }), " will apply across projects."]
        })
      })]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "caveats-1",
      ...
      id: "a-repository-pinning-an-older-package-manager-disables-the-gate",
      children: ["A repository pinning an older package manager disables the gate", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-repository-pinning-an-older-package-manager-disables-the-gate",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["If a project pins its package manager via the ", jsxRuntimeExports.jsx(_components.code, {
        children: "packageManager"
      }), " field in ", jsxRuntimeExports.jsx(_components.code, {
        children: "package.json"
      }), ", Corepack, Volta, a Docker base image, or a CI action such as ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " with ", jsxRuntimeExports.jsx(_components.code, {
        children: "version-file"
      }), ", the pinned version is the one that performs installs. When the pinned version predates cooldown support, no user-wide setting has any effect inside that repository; an older binary has no concept of the option and ignores it."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["This is the most common reason a user-wide cooldown is configured but not active. The version that actually performs the install can be confirmed by running ", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm --version"
      }), " (or the equivalent for npm, yarn, or bun) from inside the repository, or by inspecting the ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " step in the CI logs."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h4, {
      id: "a-repositorys-looser-configuration-overrides-a-stricter-user-configuration",
      children: ["A repository’s looser configuration overrides a stricter user configuration", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-repositorys-looser-configuration-overrides-a-stricter-user-configuration",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Project-level configuration takes precedence over user-level configuration in all four tools. A user-wide cooldown of one day does not apply inside a repository whose ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), ", ", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm-workspace.yaml"
      }), ", ", jsxRuntimeExports.jsx(_components.code, {
        ...
        children: "bunfig.toml"
      }), " sets a smaller value or no value at all. The setting behaves as project policy rather than as a per-user safety preference. A user-wide value, therefore, cannot serve as a backstop for repositories that have not opted in."]
    })]
  });
}
...
/*! /home/runner/work/craigory-dev/craigory-dev/libs/blog-posts/src/lib/posts/package-manager-release-cooldown/post.ts [vike:pluginModuleBanner] */
const packageManagerReleaseCooldown = {
  mdx: MDXContent$a,
  ...
  tags: ["technical", "tooling", "devops", "javascript"]
};

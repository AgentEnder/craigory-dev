...
function _createMdxContent$a(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: "Setting a minimum release age (a “cooldown”) on dependencies is a cheap, high-leverage defense against supply-chain attacks. Most malicious package versions are detected and yanked within hours, so a 24-hour delay filters out the smash-and-grab incidents (axios 1.14.1, ua-parser-js, Solana web3.js, etc.)."
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      children: "All four major Node.js package managers now support this, but each one uses a different name and a different unit. Here is what you need."
    }), "\n", jsxRuntimeExports.jsx(_components.h2, {
      id: "table-of-contents",
      children: "Table of Contents"
    }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
      children: ["\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#minimum-versions",
          children: "Minimum versions"
        })
      }), "\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.a, {
          href: "#a-few-caveats-worth-knowing",
          children: "A few caveats worth knowing"
        }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
          children: ["\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#the-cooldown-is-install-time-not-pr-time",
              children: "The cooldown is install-time, not PR-time"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#a-repo-that-pins-an-older-package-manager-wins",
              children: "A repo that pins an older package manager wins"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#user-config-doesnt-override-a-more-permissive-repo-config",
              children: "User config doesn’t override a more permissive repo config"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#no-per-registry-scoping-yet",
              children: "No per-registry scoping yet"
            })
          }), "\n", jsxRuntimeExports.jsx(_components.li, {
            children: jsxRuntimeExports.jsx(_components.a, {
              href: "#defaults-are-shifting",
              children: "Defaults are shifting"
            })
          }), "\n"]
        }), "\n"]
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#npm--per-project",
          children: "npm — per-project"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#npm--locally-user-wide",
          children: "npm — locally (user-wide)"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#pnpm--per-project",
          children: "pnpm — per-project"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#pnpm--locally-user-wide",
          children: "pnpm — locally (user-wide)"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#yarn-berry-410--per-project",
          children: "Yarn (Berry 4.10+) — per-project"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#yarn--locally-user-wide",
          children: "Yarn — locally (user-wide)"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#bun--per-project",
          children: "Bun — per-project"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#bun--locally-user-wide",
          children: "Bun — locally (user-wide)"
        })
      }), "\n"]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "minimum-versions",
      children: ["Minimum versions", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#minimum-versions",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          children: "npm"
        }), " — setting ", jsxRuntimeExports.jsx(_components.code, {
          children: "min-release-age"
        }), ", value in ", jsxRuntimeExports.jsx(_components.strong, {
          children: "days"
        }), ", introduced in npm CLI ", jsxRuntimeExports.jsx(_components.strong, {
          children: "11.10.0"
        }), " (Feb 2026)."]
      }), "\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ", introduced in pnpm ", jsxRuntimeExports.jsx(_components.strong, {
          children: "10.16"
        }), " (Sep 2025). Default of ", jsxRuntimeExports.jsx(_components.code, {
          children: "1440"
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ", introduced in Yarn Berry ", jsxRuntimeExports.jsx(_components.strong, {
          children: "4.10.0"
        }), "."]
      }), "\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "seconds"
        }), ", introduced in Bun ", jsxRuntimeExports.jsx(_components.strong, {
          children: "1.3.0"
        }), "."]
      }), "\n"]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "a-few-caveats-worth-knowing",
      children: ["A few caveats worth knowing", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-few-caveats-worth-knowing",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "I’m putting these up front because most of them have bitten me or someone I know — knowing them before you start configuring saves a lot of “why isn’t this working?” debugging later."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "the-cooldown-is-install-time-not-pr-time",
      children: ["The cooldown is install-time, not PR-time", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#the-cooldown-is-install-time-not-pr-time",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["The gate is enforced when a package manager resolves and installs versions, not when a bot suggests an update. If you’re using Renovate or Dependabot, configure their ", jsxRuntimeExports.jsx(_components.code, {
        children: "minimumReleaseAge"
      }), " / ", jsxRuntimeExports.jsx(_components.code, {
        children: "cooldown"
      }), " independently — otherwise they’ll keep opening PRs you can’t actually install. Renovate 42’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "config:best-practices"
      }), " preset already sets a 3-day default for npm; Dependabot’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "cooldown.default-days"
      }), " is the equivalent."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "a-repo-that-pins-an-older-package-manager-wins",
      children: ["A repo that pins an older package manager wins", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#a-repo-that-pins-an-older-package-manager-wins",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["If a repository pins its package manager (via ", jsxRuntimeExports.jsx(_components.code, {
        children: "packageManager"
      }), " in ", jsxRuntimeExports.jsx(_components.code, {
        children: "package.json"
      }), ", Corepack, Volta, a Docker base image, CI setup-node config, etc.) to a version that predates cooldown support, the gate is not enforced — regardless of what version is installed globally or what’s in your global config. The pinned version is the one that runs, and an older version has no concept of the setting to honor."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["This is the most common way I see the cooldown silently disabled. Always confirm the version the repo actually invokes (", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm --version"
      }), " from inside the repo, ", jsxRuntimeExports.jsx(_components.code, {
        children: "corepack pnpm --version"
      }), ", etc.) matches a version that supports the gate."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "user-config-doesnt-override-a-more-permissive-repo-config",
      children: ["User config doesn’t override a more permissive repo config", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#user-config-doesnt-override-a-more-permissive-repo-config",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["If your user-wide config sets a 1440-minute cooldown but the repo’s ", jsxRuntimeExports.jsx(_components.code, {
      ...
      }), " sets a smaller value (or ", jsxRuntimeExports.jsx(_components.code, {
        children: "0"
      }), "), the ", jsxRuntimeExports.jsx(_components.strong, {
        children: "repo wins"
      }), ". Project-level config takes precedence over user-level config in all four tools. The setting is treated as a project policy, not a user safety preference."]
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      children: "The practical implication: setting cooldown globally on your machine isn’t a substitute for setting it per-repo. A repo that doesn’t opt in is a repo without a cooldown for you."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "no-per-registry-scoping-yet",
      children: ["No per-registry scoping yet", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#no-per-registry-scoping-yet",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["None of these tools currently let you scope the gate per registry, so internal packages from a private registry get held back along with everything else unless you put them in the exclusion list (npm doesn’t have one yet — there’s an open issue, ", jsxRuntimeExports.jsx(_components.a, {
        href: "https://github.com/npm/cli/issues/8994",
        rel: "noopener noreferrer",
        target: "_blank",
        children: "npm/cli#8994"
      }), ")."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "defaults-are-shifting",
      children: ["Defaults are shifting", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#defaults-are-shifting",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "pnpm 11 already turned this on by default at 1440 minutes, and npm CLI v12 is expected to do the same. Setting it explicitly now means your config keeps working unchanged when defaults move."
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "npm--per-project",
      children: ["npm — per-project", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#npm--per-project",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Add to ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), " in the project root:"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: ".npmrc",
      ...
      children: ["The value is in days. Do not combine with ", jsxRuntimeExports.jsx(_components.code, {
        children: "--before"
      }), " in the same invocation — npm errors out if both are present. Depending on the version of the npm CLI you’re running, you may receive a warning such as:"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      children: jsxRuntimeExports.jsx(_components.code, {
      ...
      children: ["This is normal. ", jsxRuntimeExports.jsx(_components.code, {
        children: "min-release-age"
      }), " will still work."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "npm--locally-user-wide",
      children: ["npm — locally (user-wide)", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#npm--locally-user-wide",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["This writes to ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.npmrc"
      }), ". Use ", jsxRuntimeExports.jsx(_components.code, {
        children: "--location=global"
      }), " if you want it in the global npm config instead."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "pnpm--per-project",
      children: ["pnpm — per-project", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#pnpm--per-project",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Put it in ", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm-workspace.yaml"
      }), " (this is the canonical place since pnpm 11; in earlier versions ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), " also works):"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      ...
      children: "Optional, if you have internal packages you want to bypass the gate:"
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: "pnpm-workspace.yaml",
      children: jsxRuntimeExports.jsxs(_components.code, {
        className: "hljs language-yaml",
      ...
      children: ["If you’re still on pnpm 10.x, the ", jsxRuntimeExports.jsx(_components.code, {
        children: ".npmrc"
      }), " form is:"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: ".npmrc",
      ...
      children: ["Heads-up: on pnpm 10.x there’s a known bug where ", jsxRuntimeExports.jsx(_components.code, {
        children: "minimumReleaseAge"
        ...
        rel: "noopener noreferrer",
        target: "_blank",
        children: "pnpm/pnpm#10008"
      }), "). Worth checking."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "pnpm--locally-user-wide",
      children: ["pnpm — locally (user-wide)", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#pnpm--locally-user-wide",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["On pnpm 11+, non-auth settings like this go into ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.config/pnpm/config.yaml"
      }), " rather than ", jsxRuntimeExports.jsx(_components.code, {
        children: "~/.npmrc"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "yarn-berry-410--per-project",
      children: ["Yarn (Berry 4.10+) — per-project", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#yarn-berry-410--per-project",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "If you have packages that must bypass the gate:"
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      filename: ".yarnrc.yml",
      children: jsxRuntimeExports.jsxs(_components.code, {
        className: "hljs language-yaml",
      ...
      }), "), which is more flexible than pnpm’s package-name-only exclusions."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["Note: the docs say you can use duration strings like ", jsxRuntimeExports.jsx(_components.code, {
        children: "\"7d\""
      }), ", but there’s a known parsing bug (", jsxRuntimeExports.jsx(_components.a, {
        href: "https://github.com/yarnpkg/berry/issues/6991",
        rel: "noopener noreferrer",
        target: "_blank",
        children: "yarnpkg/berry#6991"
      }), ") where day suffixes were silently ignored. Until that’s resolved everywhere, just use minutes as a number. Setting cooldown to 1 day = ", jsxRuntimeExports.jsx(_components.code, {
        children: "npmMinimalAgeGate: 1440"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "yarn--locally-user-wide",
      children: ["Yarn — locally (user-wide)", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#yarn--locally-user-wide",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "bun--per-project",
      children: ["Bun — per-project", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#bun--per-project",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Add the cooldown to ", jsxRuntimeExports.jsx(_components.code, {
        children: "bunfig.toml"
      }), ":"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      ...
      children: ["The value is in seconds. Setting cooldown to 1 day = ", jsxRuntimeExports.jsx(_components.code, {
        children: "minimumReleaseAge = 86400"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["If you have packages that must bypass the gate, use ", jsxRuntimeExports.jsx(_components.code, {
      ...
      id: "bun--locally-user-wide",
      children: ["Bun — locally (user-wide)", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#bun--locally-user-wide",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["Bun doesn’t yet support user-wide configuration, but there is an open PR for it (", jsxRuntimeExports.jsx(_components.a, {
        href: "https://github.com/oven-sh/bun/pull/28727",
        rel: "noopener noreferrer",
        target: "_blank",
        children: "oven-sh/bun#28727"
      }), "). Once that gets merged, you can set your minimum release age locally with the same ", jsxRuntimeExports.jsx(_components.code, {
        children: "bunfig.toml"
      }), " you’d use in a repo."]
    })]
  });

  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: ["The value is in days. The setting cannot be combined with ", jsxRuntimeExports.jsx(_components.code, {
        children: "--before"
      }), " in the same invocation; npm raises an error if both are provided. An npm CLI version that does not recognize the key emits the following warning:"]
    }), "\n", jsxRuntimeExports.jsx(_components.pre, {
      children: jsxRuntimeExports.jsx(_components.code, {
      ...
      children: "The warning is cosmetic. The setting applies on a supporting CLI and is harmlessly ignored on one that does not support it."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "user-wide",

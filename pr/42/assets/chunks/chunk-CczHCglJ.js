...
function _createMdxContent$a(props) {
  const _components = {
    ...
    ul: "ul",
    ...props.components
  }, {Anchor, PackageManagerTab, PackageManagerTabs} = _components;
  if (!Anchor) _missingMdxReference$a("Anchor");
  if (!PackageManagerTab) _missingMdxReference$a("PackageManagerTab");
  if (!PackageManagerTabs) _missingMdxReference$a("PackageManagerTabs");
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: ["A minimum release age (or “cooldown”) instructs a package manager to ignore any dependency version published less than a configured amount of time ago. Most malicious releases are reported and removed from the registry within a few hours of publication, so even a 24-hour delay screens out the majority of compromised versions before they reach a local install.", jsxRuntimeExports.jsx("sup", {
      ...
      children: ["Each major Node.js package manager now supports this configuration, though the setting name and the unit of time differ in each one. The reference below was assembled from Matteo Collina’s original gist covering npm, pnpm, and Yarn,", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
      }), " Tom Ricci’s expansion adding Bun,", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-2",
          children: "[2]"
        })
      }), " and the official documentation for each tool.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-3",
          children: "[3]"
        })
      }), jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-4",
          children: "[4]"
        })
      ...
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "11.10.0"
        }), " (February 2026).", jsxRuntimeExports.jsx("sup", {
          children: jsxRuntimeExports.jsx("a", {
            href: "#ref-3",
            children: "[3]"
          })
      ...
      children: "Several aspects of the cooldown’s behavior can cause it to be silently bypassed. They are documented here, ahead of the per-tool configuration, because each one is a common source of misconfiguration."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      ...
      }), " preset enables a three-day cooldown for npm by default.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
      ...
      }), ", the pinned version is the one that performs installs. When the pinned version predates cooldown support, the setting has no effect, regardless of the globally installed package manager or any global configuration. An older binary has no concept of the option and ignores it."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["This is the most common reason for a cooldown to be present in configuration but absent in effect. The version that actually performs the install can be confirmed by running ", jsxRuntimeExports.jsx(_components.code, {
      ...
      }), " sets a smaller value or no value at all. The setting behaves as project policy rather than as a per-user safety preference. A global value, therefore, cannot serve as a backstop for repositories that have not opted in."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      ...
      children: ["pnpm 11 enables the gate by default at 1440 minutes, and npm CLI v12 is expected to do the same.", jsxRuntimeExports.jsx("sup", {
        children: jsxRuntimeExports.jsx("a", {
          href: "#ref-1",
          children: "[1]"
        })
    ...
    }), "\n", jsxRuntimeExports.jsxs(PackageManagerTabs, {
      children: [jsxRuntimeExports.jsxs(PackageManagerTab, {
        manager: "npm",
      ...
      }), jsxRuntimeExports.jsxs(PackageManagerTab, {
        manager: "pnpm",
        children: [jsxRuntimeExports.jsxs(_components.p, {
        ...
        children: [jsxRuntimeExports.jsxs(_components.p, {
          ...
          children: ["The documentation states that a duration suffix such as ", jsxRuntimeExports.jsx(_components.code, {
            children: "\"7d\""
          }), " is accepted, but a known parsing bug causes the suffix to be dropped.", jsxRuntimeExports.jsx("sup", {
            children: jsxRuntimeExports.jsx("a", {
              href: "#ref-9",
              children: "[9]"
            })
      ...
      children: "User-wide configuration applies on a single machine, across every repository that does not override it. As noted in the caveats above, project-level configuration takes precedence over the values shown here."
    }), "\n", jsxRuntimeExports.jsxs(PackageManagerTabs, {
      children: [jsxRuntimeExports.jsxs(PackageManagerTab, {
        manager: "npm",
      ...
      }), jsxRuntimeExports.jsx(PackageManagerTab, {
        manager: "bun",
        children: jsxRuntimeExports.jsxs(_components.p, {
          children: ["Bun reads project-level ", jsxRuntimeExports.jsx(_components.code, {
            children: "bunfig.toml"
          }), " only; user-wide configuration is not yet supported. An open pull request adds the corresponding behavior.", jsxRuntimeExports.jsx("sup", {
            children: jsxRuntimeExports.jsx("a", {
              href: "#ref-10",
              children: "[10]"
            })
      ...
      children: [jsxRuntimeExports.jsxs("li", {
        ...
        }), " (gist, April 2026). Original write-up covering npm, pnpm, and Yarn, including the install-time vs. PR-time distinction and the expected default shifts."]
        ...
        children: ["Tom Ricci, ", jsxRuntimeExports.jsx("a", {
          ...
          children: "“Configuring minimum release age across npm, pnpm, yarn, and bun”"
        }), " (gist). Extends Collina’s notes with Bun coverage, version metadata, and the per-tool exclusion options."]
      }), jsxRuntimeExports.jsxs("li", {
        id: "ref-3",

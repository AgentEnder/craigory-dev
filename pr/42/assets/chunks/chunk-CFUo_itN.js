...
const pnpmDocs = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  ...
  }), ". Notes the default of ", jsxRuntimeExports.jsx("code", {
    children: "1440"
...
const renovateBestPractices = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["Renovate documentation,", ' ', jsxRuntimeExports.jsx("a", {
    href: "https://docs.renovatebot.com/presets-config/#configbest-practices",
    children: jsxRuntimeExports.jsx("code", {
      children: "config:best-practices"
    })
  }), ' ', "preset. Includes ", jsxRuntimeExports.jsx("code", {
    children: "security:minimumReleaseAgeNpm"
  }), ", which waits three days before raising an npm update."]
});
const dependabotCooldown = jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
  children: ["GitHub Docs,", ' ', jsxRuntimeExports.jsx("a", {
  ...
  }), ", covering ", jsxRuntimeExports.jsx("code", {
    children: "default-days"
...
function _createMdxContent$a(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: "A minimum release age (or “cooldown”) instructs a package manager to ignore any dependency version published less than a configured amount of time ago. The reference below covers the four major Node.js package managers; the setting name and the unit of time differ in each."
    }), "\n", jsxRuntimeExports.jsx(_components.h2, {
      id: "table-of-contents",
      children: "Table of Contents"
    }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
      ...
      children: "A cooldown delays a freshly published version from being installable. Compromised releases are usually flagged and removed from the registry within hours of publication, so even a 24-hour delay filters most of those incidents at the install layer without monitoring or scanning."
    }), "\n", jsxRuntimeExports.jsx(_components.p, {
      ...
      children: ["The setting can be written per-project or per-user. A per-project value protects the codebase against newly published policy violations; a user-wide value extends the cooldown to repositories that have not opted in. Both are worth setting; neither replaces the other, and the conditions under which either is silently bypassed are listed in the ", jsxRuntimeExports.jsx(_components.a, {
        href: "#caveats",
        children: "caveats"
      }), " below."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      ...
      children: "User-wide configuration applies on a single machine, across every repository that does not override it."
    }), "\n", jsxRuntimeExports.jsxs(Tabs, {
      groupId: "package-manager",
      children: [jsxRuntimeExports.jsxs(Tab, {
        label: "npm",
      ...
      children: "A handful of conditions can quietly bypass the configured cooldown or change what is actually being honored."
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: [jsxRuntimeExports.jsx(_components.strong, {
        children: "The check runs at install time, not when an updater opens a PR."
      }), " Renovate and Dependabot evaluate updates independently of the package manager’s cooldown, so their own cooldown options must be set separately. Both ship reasonable defaults: Renovate’s ", jsxRuntimeExports.jsx(_components.code, {
        children: "config:best-practices"
      }), " preset waits three days before raising an npm update,", jsxRuntimeExports.jsx(Cite, {
        n: 5,
        href: "https://docs.renovatebot.com/presets-config/#configbest-practices",
        children: renovateBestPractices
      }), " and Dependabot exposes ", jsxRuntimeExports.jsx(_components.code, {
        children: "cooldown.default-days"
      }), " with semver-specific overrides.", jsxRuntimeExports.jsx(Cite, {
        n: 6,
        href: "https://docs.github.com/en/code-security/dependabot/dependabot-version-updates/configuration-options-for-the-dependabot.yml-file#cooldown",
      ...
      children: [jsxRuntimeExports.jsx(_components.strong, {
        children: "A repository’s pinned package manager is what actually runs the install."
      }), " A pin via the ", jsxRuntimeExports.jsx(_components.code, {
        children: "packageManager"
      }), " field, Corepack, Volta, a Docker base image, or ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " with ", jsxRuntimeExports.jsx(_components.code, {
        children: "version-file"
      }), " overrides whatever is installed globally. If the pinned version predates cooldown support, every layer of configuration above it is inert. The most reliable check is to run ", jsxRuntimeExports.jsx(_components.code, {
        children: "pnpm --version"
      }), " (or the equivalent) from inside the repository, or to inspect the ", jsxRuntimeExports.jsx(_components.code, {
        children: "setup-node"
      }), " step in the CI log."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: [jsxRuntimeExports.jsx(_components.strong, {
        children: "Project-level configuration takes precedence over user-level configuration in all four tools."
      }), " A user-wide cooldown of one day does not apply inside a repository whose project config sets a smaller value or none at all. A user-wide value is not a backstop for repositories that have not opted in."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: [jsxRuntimeExports.jsx(_components.strong, {
        children: "None of the four tools support per-registry scoping."
      }), " Internal packages from a private registry are subject to the cooldown unless explicitly listed in the per-tool exclusion option. npm does not yet expose one; an issue is open against the CLI tracking it.", jsxRuntimeExports.jsx(Cite, {
        n: 7,
        href: "https://github.com/npm/cli/issues/8994",
      ...
      children: [jsxRuntimeExports.jsx(_components.strong, {
        children: "Defaults are shifting upward."
      }), " pnpm 11 ships with the gate enabled at 1440 minutes by default.", jsxRuntimeExports.jsx(Cite, {
        n: 2,
        href: "https://pnpm.io/settings#minimumreleaseage",
        children: pnpmDocs
      }), " Setting an explicit value insulates the configured behavior against changes elsewhere in the ecosystem."]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "acknowledgements",
      children: ["Acknowledgements", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#acknowledgements",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "This digest closely follows two gists that did the original work of pulling the per-tool settings together:"
    }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {

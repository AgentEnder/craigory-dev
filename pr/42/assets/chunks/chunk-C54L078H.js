...
function _createMdxContent$a(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.h1, {
      ...
      children: ["A minimum release age (or “cooldown”) instructs a package manager to ignore any dependency version published less than a configured amount of time ago. Most malicious releases are reported and removed from the registry within a few hours of publication, so even a 24-hour delay screens out the majority of compromised versions before they reach a local install.", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      })]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["Each major Node.js package manager now supports this configuration, though the setting name and the unit of time differ in each one. The reference below was assembled from Matteo Collina’s original gist covering npm, pnpm, and Yarn,", jsxRuntimeExports.jsx(Cite, {
        n: 1,
        href: "https://gist.github.com/mcollina/b294a6c39ee700d24073c0e5a4e93104",
        children: collinaGist
      ...
      children: ["\n", jsxRuntimeExports.jsx(_components.li, {
        ...
        children: [jsxRuntimeExports.jsx(_components.a, {
          ...
          children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
            children: [jsxRuntimeExports.jsx(_components.a, {
              href: "#per-project-pitfalls",
              children: "Per-project pitfalls"
            }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
              children: ["\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
            ...
            children: [jsxRuntimeExports.jsx(_components.a, {
              href: "#user-wide-pitfalls",
              children: "User-wide pitfalls"
            }), "\n", jsxRuntimeExports.jsxs(_components.ul, {
              children: ["\n", jsxRuntimeExports.jsx(_components.li, {
                children: jsxRuntimeExports.jsx(_components.a, {
        ...
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#per-project-configuration",
          children: "Per-project configuration"
        })
      }), "\n", jsxRuntimeExports.jsx(_components.li, {
        children: jsxRuntimeExports.jsx(_components.a, {
          href: "#user-wide-configuration",
          children: "User-wide configuration"
        })
      }), "\n"]
    }), "\n", jsxRuntimeExports.jsxs(_components.h2, {
      id: "quick-reference",
      children: ["Quick reference", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#quick-reference",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: ["\n", jsxRuntimeExports.jsxs(_components.li, {
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "days"
        }), ". Supported in npm CLI ", jsxRuntimeExports.jsx(_components.strong, {
          children: "11.10.0"
        }), " (February 2026).", jsxRuntimeExports.jsx(Cite, {
          n: 3,
          href: "https://docs.npmjs.com/cli/v11/using-npm/config#min-release-age",
          children: npmDocs
        })]
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ". Supported in pnpm ", jsxRuntimeExports.jsx(_components.strong, {
          children: "10.16"
        }), " (September 2025). The default became ", jsxRuntimeExports.jsx(_components.code, {
          children: "1440"
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "minutes"
        }), ". Supported in Yarn Berry ", jsxRuntimeExports.jsx(_components.strong, {
          children: "4.10.0"
        }), ".", jsxRuntimeExports.jsx(Cite, {
          n: 5,
          href: "https://yarnpkg.com/configuration/yarnrc#npmMinimalAgeGate",
        ...
        children: [jsxRuntimeExports.jsx(_components.strong, {
          ...
          children: "seconds"
        }), ". Supported in Bun ", jsxRuntimeExports.jsx(_components.strong, {
          children: "1.3.0"
        }), ".", jsxRuntimeExports.jsx(Cite, {
          n: 6,
          href: "https://bun.sh/docs/runtime/bunfig#install-minimumreleaseage",
      ...
      children: "Several aspects of the cooldown’s behavior can cause it to be silently bypassed. The pitfalls below are grouped by which configuration scope they affect; each tends to bite one form of setup more than the other."
    }), "\n", jsxRuntimeExports.jsxs(_components.h3, {
      id: "per-project-pitfalls",
      children: ["Per-project pitfalls", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#per-project-pitfalls",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "user-wide-pitfalls",
      children: ["User-wide pitfalls", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#user-wide-pitfalls",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      id: "per-project-configuration",
      children: ["Per-project configuration", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#per-project-configuration",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "Per-project configuration is committed to the repository and applies to every developer and CI run that uses a supported package manager version. The selected tab is remembered across the rest of the post."
      ...
      id: "user-wide-configuration",
      children: ["User-wide configuration", jsxRuntimeExports.jsx(_components.a, {
        className: "heading-link",
        href: "#user-wide-configuration",
        children: jsxRuntimeExports.jsx(Anchor, {
          className: "heading-link-anchor",
      ...
      children: "User-wide configuration applies on a single machine, across every repository that does not override it. As noted in the user-wide pitfalls above, project-level configuration takes precedence over the values shown here."
    }), "\n", jsxRuntimeExports.jsxs(Tabs, {
      groupId: "package-manager",
      children: [jsxRuntimeExports.jsxs(Tab, {
        label: "npm",

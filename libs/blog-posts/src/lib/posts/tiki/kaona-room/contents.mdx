...
This section's a bit different here as the drink menu served was not that of Kaona's, but due to the location in Miami I was able to order a few daiquiri variants that were all well made. It was nice to order them and not be met with confusion about not expecting them to be frozen, as classic daiquiris are pretty popular in the area.

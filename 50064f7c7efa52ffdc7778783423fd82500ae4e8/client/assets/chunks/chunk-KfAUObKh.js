...
const onRenderClient = (pageContext) => {
    ...
    container.innerHTML !== '' &&
        ...
        // Hydration
        root = client.hydrateRoot(container, page, {
            // @ts-expect-error
            onUncaughtError
        });
    }
...
var define_import_meta_env_default = { BASE_SERVER: "/", BASE_ASSETS: "/", BASE_URL: "/", MODE: "production", DEV: false, PROD: true, SSR: false };
function Link(p) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      href: define_import_meta_env_default.PUBLIC_ENV__BASE_URL === "/" || !define_import_meta_env_default.PUBLIC_ENV__BASE_URL ? href : define_import_meta_env_default.PUBLIC_ENV__BASE_URL + href,
      ...props,
      className,
      children: [
        children,
        define_import_meta_env_default.PUBLIC_ENV__BASE_URL
      ]
    }
  );
}

function MinimumPageShell({
  children,
  pageContext
}) {
...
const blogPosts = [nxConfigurationHistory].sort((a, b) => a.publishDate.getTime() - b.publishDate.getTime());
const slugMap = Object.fromEntries(blogPosts.map((p) => [p.slug, p]));
const pages = partition(blogPosts, 10);
...
function PageShell({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MinimumPageShell, { pageContext, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "navitem", href: `/blog/${pageCount}`, children: "Blog" })
      ] }),
...
function Layout({ children }) {
  const pageContext = usePageContext();
  return pageContext.urlPathname.includes("presentations/view") ? /* @__PURE__ */ jsxRuntimeExports.jsx(MinimumPageShell, { pageContext, children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { pageContext, children });
}
...
export { GenIcon as G, Link as L, import4 as a, import1 as i, jsxRuntimeExports as j, onRenderClient as o, pages as p, reactExports as r, slugMap as s, toast as t, usePageContext as u };
